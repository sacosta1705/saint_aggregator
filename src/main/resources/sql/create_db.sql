...
CREATE TABLE Products(
	...
	pricet1 DECIMAL(28,4) NULL,
	pricet2 DECIMAL(28,4) NULL,
	pricet3 DECIMAL(28,4) NULL,
...
CREATE TABLE Services (
	...
	price2 DECIMAL(28,4) NOT NULL,
	price3 DECIMAL(28,4) NOT NULL,
	price1t DECIMAL(28,4) NULL,
	price2t DECIMAL(28,4) NULL,
	price3t DECIMAL(28,4) NULL,
	state BIT NOT NULL DEFAULT 1,

	CONSTRAINT fk_service_store FOREIGN KEY (storeid) REFERENCES Stores(id) ON DELETE CASCADE,
	CONSTRAINT uq_service_store_code UNIQUE(storeid, code)
);
